...
class EducationalLoanForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'score_card': forms.ClearableFileInput(attrs={'class': 'form-control'}),
            ...
            'co_applicant_self_employed_business_licence': forms.FileInput(attrs={'class': 'form-control self-employed-field hidden'}),
    ...
    def __init__(self, *args, **kwargs):
        ...
        super(EducationalLoanForm, self).__init__(*args, **kwargs)
...
class DocumentsForm(forms.ModelForm):
    ...
    class Meta:
        ...
        exclude = ['loan']
        labels = {
         'adhar_card_front': 'Aadhar Card Front (JPEG)',
         'adhar_card_back': 'Aadhar Card Back (JPEG)',
         'pan_card': 'Pan Card  (JPEG)',
         'customer_photo': 'Customer Photo (JPEG)',
         'pay_slip_1': 'Pay Slip 1 (PDF)',
         'pay_slip_2': 'Pay Slip 3 (PDF)',
