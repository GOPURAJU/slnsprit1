...
def goldbasicdetails(request):
    ...
    return render(request, 'customer/goldbasicdetailform.html',{'form':form})
...
def update_lapdoc(request, instance_id):
    ...
    return render(request, 'customer/update.html', {
        'form': form,
        'random_number': personal_details.random_number,
        'incomesource': personal_details.income_source,
        'loan_type': personal_details.loan_type,
    })
def lapview(request):
...
def LoanAgainstProperty(request):
    email = request.session.get('email')
    return render(request, 'LoanAgainstProperty.html',{'email':email})
...
=======
    return render(request,'AllInsurance.html',{'form':form,'email':email})
...
def Healthinsurance(request):
    ...
    email = request.session.get('email')
=======
    return render(request, 'GeneralInsurance.html',{'form':form,'email':email})
...
def Lifeinsurance(request):
    ...
    hl=CustomerProfile.objects.filter(email_id=email)
=======
       return render(request, 'HealthInsurance.html',{'form':'form','email':email})
...
=======
       return render(request, 'LifeInsurance.html',{'form':form,'email':email})
    

def BussinessLoan(request):
    email = request.session.get('email')
    return render(request, 'BussinessLoan.html',{'email':email})

def CarLoan(request):
    email = request.session.get('email')
    return render(request, 'CarLoan.html',{'email':email})
...
def creditpage(request):
    email = request.session.get('email')
    return render(request, 'creditpage.html',{'email':email})

def dsa(request):
    email = request.session.get('email')
    return render(request, 'dsa.html',{'email':email})

def Educationalloan(request):
    email = request.session.get('email')
    return render(request, 'Educationalloan.html',{'email':email})

def franchise(request):
    email = request.session.get('email')
    return render(request, 'franchise.html',{'email':email})
>>>>>>> origin/master
...
=======
    return render(request, 'GoldLoan.html',{'email':email})
>>>>>>> origin/master
...
=======
    return render(request, 'HomeLoan.html',{'email':email})
...
def NewCarLoan(request):
    email = request.session.get('email')
    return render(request, 'NewCarLoan.html',{'email':email})

def Personalloans(request):
    email = request.session.get('email')
    return render(request, 'Personalloans.html',{'email':email})

def UsedCarLoan(request):
    email = request.session.get('email')
    return render(request, 'UsedCarLoan.html',{'email':email})
>>>>>>> origin/master
