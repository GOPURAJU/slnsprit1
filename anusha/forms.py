...
class LapDocumentUploadForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            'adhar_card_front': forms.FileInput(attrs={'class': 'form-control','placeholder':'upload image format'}),
            'adhar_card_back': forms.FileInput(attrs={'class': 'form-control','placeholder':'upload image format'}),
            'pan_card': forms.FileInput(attrs={'class': 'form-control','placeholder':'upload image format'}),
            'customer_photo': forms.FileInput(attrs={'class': 'form-control','placeholder':'upload image format'}),
            'property_photo1': forms.FileInput(attrs={'class': 'form-control','placeholder':'upload image format'}),
            'property_photo2': forms.FileInput(attrs={'class': 'form-control','placeholder':'upload image format'}),
            'property_photo3': forms.FileInput(attrs={'class': 'form-control','placeholder':'upload image format'}),
            'property_photo4': forms.FileInput(attrs={'class': 'form-control','placeholder':'upload image format'}),
            'pay_slips': forms.FileInput(attrs={'class': 'form-control','placeholder':'upload pdf format'}),
            'bank_statement': forms.FileInput(attrs={'class': 'form-control','placeholder':'upload pdf format'}),
            'employee_id_card': forms.FileInput(attrs={'class': 'form-control','placeholder':'upload image format'}),
            'business_proof1': forms.FileInput(attrs={'class': 'form-control','placeholder':'upload pdf format'}),
            'business_proof2': forms.FileInput(attrs={'class': 'form-control','placeholder':'upload pdf format'}),
            'bank_statement_12m': forms.FileInput(attrs={'class': 'form-control','placeholder':'upload pdf format'}),
            'business_office_photo': forms.FileInput(attrs={'class': 'form-control','placeholder':'upload image format'}),
            'itr1': forms.FileInput(attrs={'class': 'form-control','placeholder':'upload pdf format'}),
            'itr2': forms.FileInput(attrs={'class': 'form-control','placeholder':'upload pdf format'}),
            'itr3': forms.FileInput(attrs={'class': 'form-control','placeholder':'upload pdf format'}),
            'address_proof': forms.FileInput(attrs={'class': 'form-control','placeholder':'upload pdf format'}),
            'existing_loan_statement': forms.FileInput(attrs={'class': 'form-control','placeholder':'upload pdf format'}),
            'other_document1': forms.FileInput(attrs={'class': 'form-control','placeholder':'upload pdf format'}),
            'other_document2': forms.FileInput(attrs={'class': 'form-control','placeholder':'upload pdf format'}),
            'other_document3': forms.FileInput(attrs={'class': 'form-control','placeholder':'upload pdf format'}),
            'other_document4': forms.FileInput(attrs={'class': 'form-control','placeholder':'upload pdf format'}),

            'co_applicant_adhar_card_front': forms.FileInput(attrs={'class': 'form-control','placeholder':'upload image format'}),
            'co_applicant_adhar_card_back': forms.FileInput(attrs={'class': 'form-control','placeholder':'upload image format'}),
            'co_applicant_pan_card': forms.FileInput(attrs={'class': 'form-control','placeholder':'upload image format'}),
            'co_applicant_selfie_photo': forms.FileInput(attrs={'class': 'form-control','placeholder':'upload image format'}),
